...
(custom-set-variables
 ...
 '(package-selected-packages
   '(eshell-prompt-extras eshell-git-prompt beancount calfw-org exec-path-from-shell use-package-ensure-system-package delight which-key vterm visual-fill-column use-package typescript-mode terraform-mode rainbow-delimiters org-superstar org-roam org-fancy-priorities org-download org-contacts neotree lsp-ui lsp-treemacs lsp-pyright lsp-ivy ivy-rich general evil-nerd-commenter evil-leader evil-collection ebdb doom-themes doom-modeline counsel-projectile company-box command-log-mode all-the-icons))
